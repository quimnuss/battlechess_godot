...
# looks like gut can't test nodes
...
func test_assert_board_neighbours__center():
    ...
    assert_eq(neighbours, [Vector2i(0,0),Vector2i(0,1),Vector2i(0,2),Vector2i(1,0),Vector2i(1,1),Vector2i(1,2),Vector2i(2,0),Vector2i(2,1),Vector2i(2,2)], "corner has all tiles")
